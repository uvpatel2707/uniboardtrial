            ...
            <Row>
                ...
                <Col sm={12} lg={2}>
                    ...
                    <p className='footerSocialLogo'>
                        <img src='./imgs/footer/fb.png' alt='facebbokLogo'></img>
                        <img src='./imgs/footer/tw.png' alt='twitterLogo' style={{paddingLeft : "10px"}}></img>
                    </p>
                </Col>
            </Row>
            <div className='footerLine'></div>
            <p className='footerCopyrightText'>@2022 - Defence Hub. All rights reserved</p>
        </Container>
      </>
  );
};
